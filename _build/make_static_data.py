...
CHRONO_ORDER = [
    "zhu_hongen", "genesis_primeval", "abraham", "sarah", "lot", "melchizedek",
    "hagar", "isaac", "rebekah", "esau", "jacob", "leah",
    "rachel", "reuben", "judah", "tamar_judah", "perez", "zerah",
    "hezron", "joseph_patriarch", "benjamin", "job", "moses", "aaron",
    "miriam", "balaam", "ram", "amminadab", "nahshon", "caleb",
    "joshua", "rahab", "achan", "ehud", "deborah", "gideon",
    "jephthah", "manoah", "samson", "delilah", "naomi", "ruth",
    "boaz", "jesse", "eli", "hannah", "samuel", "saul_king",
    "jonathan", "michal", "abigail", "nabal", "david", "mephibosheth",
    "bathsheba", "uriah", "nathan_prophet", "absalom", "tamar_david", "amnon",
    "joab", "solomon", "queen_of_sheba", "jeroboam", "rehoboam", "abijah_king",
    "asa", "jehoshaphat", "joram_king", "ahab", "jezebel", "naboth",
    "elijah", "elisha", "naaman", "gehazi", "jehu", "jonah",
    "hosea", "isaiah", "uzziah", "jotham", "ahaz", "hezekiah",
    "manasseh", "amon", "josiah", "jeremiah", "jeconiah", "ezekiel",
    "daniel", "esther", "haman", "mordecai", "shealtiel", "zerubbabel",
    ...
    "matthew", "james_alphaeus", "thaddaeus", "simon_zealot", "judas_iscariot", "nicodemus",
    "samaritan_woman", "jairus", "bleeding_woman", "canaanite_woman", "herod_antipas", "rich_young_ruler",
    "martha", "mary_bethany", "lazarus", "zacchaeus", "bartimaeus", "samaritan_leper",
    "mary_magdalene", "james_brother", "jude_brother", "caiaphas", "pontius_pilate", "barabbas",
    ...
    "dorcas", "cornelius", "john_mark", "silas", "timothy", "lydia",
    "philippian_jailer", "priscilla_aquila", "apollos", "titus", "phoebe", "onesimus",
    "luke",
]
