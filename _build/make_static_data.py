...
CHRONO_ORDER = [
    ...
    "saul_king", "jonathan", "abner", "michal", "abigail", "nabal",
    "david", "mephibosheth", "bathsheba", "uriah", "nathan_prophet", "absalom",
    "tamar_david", "amnon", "joab", "solomon", "queen_of_sheba", "jeroboam",
    "rehoboam", "abijah_king", "asa", "jehoshaphat", "joram_king", "ahab",
    "jezebel", "elijah", "widow_zarephath", "naboth", "elisha", "shunammite_woman",
    "naaman", "gehazi", "jehu", "jonah", "hosea", "isaiah",
    ...
    "samaritan_woman", "jairus", "bleeding_woman", "canaanite_woman", "herod_antipas", "herodias",
    "rich_young_ruler",
