...
CHRONO_ORDER = [
    ...
    "hezron", "joseph_patriarch", "potiphars_wife", "benjamin", "job",
    "pharaoh_exodus", "shiphrah_puah", "jochebed", "pharaohs_daughter", "moses", "aaron", "hur", "jethro",
    "miriam", "bezalel", "korah", "balaam", "balak", "ram", "amminadab", "nahshon", "caleb",
    "joshua", "rahab", "achan", "othniel", "ehud", "shamgar", "deborah", "jael",
    "gideon", "abimelech_gideon", "tola", "jair_judge", "jephthah", "jephthahs_daughter",
    "manoah", "samson", "delilah", "micah_ephraim", "naomi",
    "ruth", "boaz", "jesse", "eli", "hannah", "samuel",
    "saul_king", "jonathan", "abner", "rizpah", "michal", "abigail", "nabal",
    "david", "mephibosheth", "ziba", "bathsheba", "uriah", "nathan_prophet",
    "tamar_david", "amnon", "absalom", "hushai", "ahithophel", "shimei", "barzillai",
    "joab", "abishai", "amasa", "sheba_bichri", "adonijah",
